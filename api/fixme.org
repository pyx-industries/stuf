...
** DONE Clean up Test Suite Organization (P3)
...
*** DONE Remove unused BDD-related files and directories
...
**** Completion Criteria
- [X] All specified BDD feature files are deleted.
- [X] All specified BDD step definition files are deleted.
- [X] `api/tests/step_defs/` directory is removed.
- [X] `api/tests/features/` directory is removed.
- [X] The project structure is cleaner and less cluttered by unused BDD artifacts.
