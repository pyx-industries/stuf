...
class TestFilesAPIIntegration:
    ...
    def test_delete_file_with_valid_auth(self, integration_client, authenticated_headers):
        ...
        integration_client.storage_repo_mock.delete_file.assert_called_once_with("test/user/test-file.txt")
    ...
    def test_delete_file_wrong_collection_permission(self, integration_client, limited_user_headers):
    ...
    def test_delete_file_storage_error(self, integration_client, authenticated_headers):
        ...
        integration_client.storage_repo_mock.file_exists.return_value = True  # File exists, but delete fails
        integration_client.storage_repo_mock.delete_file.side_effect = StorageError("Storage error")
